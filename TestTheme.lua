...
TestTheme.Frame.draw = function(self)
    ...
    if self.draggable then
        ...
        love.graphics.rectangle('fill', self.x + self.resize_margin_left, self.y + self.resize_margin_top, 
                                self.w - (self.resize_margin_left + self.resize_margin_right), self.drag_margin)
    end
