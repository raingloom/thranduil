...
function love.load()
    ...
    scrollarea = UI.Scrollarea(240, 10, 400, 400, {extensions = {TestTheme.Scrollarea}, scrollbar_button_extensions = {TestTheme.Button}, area_width = 185, area_height = 185, show_scrollbars = true})
